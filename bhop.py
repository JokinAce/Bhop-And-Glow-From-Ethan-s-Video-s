...
dwForceAttack = (0x3184A80)
dwForceAttack2 = (0x3184A8C)
dwForceBackward = (0x3184A38)
dwForceForward = (0x3184A44)
dwForceJump = (0x51FD20C)
dwForceLeft = (0x3184A5C)
dwForceRight = (0x3184A50)
dwGameDir = (0x6296F8)
dwGameRulesProxy = (0x52704FC)
dwGetAllClasses = (0xD652CC)
dwGlobalVars = (0x58AAD8)
dwGlowObjectManager = (0x529B3C8)
dwInput = (0x51A4AC8)
dwInterfaceLinkList = (0x9077D4)
dwLocalPlayer = (0xD3EC6C)
dwMouseEnable = (0xD44810)
dwMouseEnablePtr = (0xD447E0)
dwPlayerResource = (0x3182DD0)
dwRadarBase = (0x518825C)
dwSensitivity = (0xD446AC)
dwSensitivityPtr = (0xD44680)
dwSetClanTag = (0x89FB0)
dwViewMatrix = (0x4D44E34)
dwWeaponTable = (0x51A5588)
dwWeaponTableIndex = (0x325C)
dwYawPtr = (0xD44470)
dwZoomSensitivityRatioPtr = (0xD49710)
dwbSendPackets = (0xD41DA)
dwppDirect3DDevice9 = (0xA7030)
find_hud_element = (0x27EF36A0)
force_update_spectator_glow = (0x3A2612)
interface_engine_cvar = (0x3E9EC)
is_c4_owner = (0x3AF0C0)
m_bDormant = (0xED)
m_flSpawnTime = (0xA370)
m_pStudioHdr = (0x294C)
m_pitchClassPtr = (0x51884F8)
m_yawClassPtr = (0xD44470)
